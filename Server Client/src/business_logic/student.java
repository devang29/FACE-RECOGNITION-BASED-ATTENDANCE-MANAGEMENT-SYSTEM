...
public class student {
    ...
    public boolean insert(String stuid,int sem,String deptid,String div,InputStream img,int imglen,int mobile,String email)
    {
        boolean i=false;
        try 
        {            
    ...
    public int getMobile(String stuid)
    {
        int i=0;
        try {
            if(!rs.isBeforeFirst())
    ...
    public boolean update(String stuid,int sem,String deptid,String div,InputStream img,int imglen,int mobile,String email)
    {
        boolean i=false;
        try 
        {  
